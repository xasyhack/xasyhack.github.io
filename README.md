...
- [Insecure Deserialization](#insecure-deserialization)
  - [Lab (10)](#insecure-deserialization-lab)
- [Web LLM Attacks](#web-llm-attacks)
  - [Lab (4)](#web-llm-attacks-lab)
- [GraphQL API](#graphql-api)
  - [Lab (5)](#graphql-api-lab)
- [Server-side Template Injection](#server-side-template-injection)
  - [Lab (7)](#server-side-template-injection-lab)
- [Web Cache Poisoning](#web-cache-poisoning)
  - [Lab (13)](#web-cache-poisoning-lab)
...
- [JWT Attacks](#jwt-attacks)
  - [Lab (8)](#jwt-attacks-lab)
- [Prototype Pollution](#prototype-pollution)
  - [Lab (10)](#prototype-pollution-lab)
- [Essential Skills](#essential-skills)
  - [Lab (2)](#essential-skills-lab)
...
- Performing **CSRF** exploits over GraphQL
  - email change request > send to repeater > POST /graphql/v1
   ...
   - Request Body  
     ...
     ```
  - URL encode the query value except `&variables={"input":{"email":"wiener2@normal-user.net"}}`
  - Generate CSRF PoC  
     ```
     <html>
	  <!-- CSRF PoC - generated by Burp Suite Professional -->
